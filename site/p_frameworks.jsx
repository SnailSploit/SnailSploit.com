...
const FRAMEWORK_INDEX = [
  { key: "AATMF", name: "AATMF v3", sub: "Adversarial AI Threat Modeling Framework", href: "/aatmf",
    desc: "15 tactics. 240 techniques. 2,150+ procedures. The structured catalog for AI red teaming — mapped to MITRE ATLAS, OWASP LLM Top 10, NIST AI RMF, and the EU AI Act.",
