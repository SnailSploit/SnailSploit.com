...
const ToolkitPage = () => (
 ...
 ["L3", "AATMF-R scoring + report", "Every result scored on the six AATMF-R factors (L · I · E · D · R · C). Report exports to JSON, Markdown, and a slide-ready PDF. Mappings to MITRE ATLAS, NIST AI RMF, and EU AI Act emit alongside the raw scores."],
 ].map(([k, n, d], i) => (
...
$ aatmf run --all --endpoint <url> --output report.json --format aatmf-r`}
 ...
 ["Compliance export", "· MITRE ATLAS · NIST AI RMF · EU AI Act mappings emit automatically with each report."],
 ].map(([t, d], i) => (
