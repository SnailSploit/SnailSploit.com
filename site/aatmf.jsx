...
const AATMF = {
  ...
  quickStart: [
    ...
    ["Map to compliance",              "OWASP · MITRE · NIST · EU AI Act",           "/frameworks/aatmf/governance/"],
  ...
  volumes: [
    ...
    ["VI",  "Governance & Compliance",     "Risk management framework, compliance mapping to OWASP / MITRE / NIST / EU AI Act, and training programs."],
...
└── Supporting Infrastructure
    ...
    └── Compliance Mappings    OWASP · ATLAS · NIST · EU AI Act`}
      </pre>
...
const Mapping = () => (
  <Section id="mapping" label="05 · cross-framework"
    hint="AATMF maps directly to the standards enterprises already use. Additional mappings: OWASP Agentic Top 10 (Dec 2025), NIST AI RMF / IR 8596, EU AI Act risk categories, CWE / CVE."
    title="cross-framework mapping: mitre atlas, owasp, nist.">
    ...
    <div>
      <div style={{ display:"grid", gridTemplateColumns:"1.4fr 1.2fr 1.4fr", gap:24, padding:"0 0 12px", borderBottom:"1px solid var(--line-hi)" }}>
        ...
        <Mono color="var(--fg-3)" size={11}>owasp llm top 10</Mono>
      </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1.1fr 1fr", gap:64, alignItems:"start" }}>
        <div>
          ...
          <p style={{ marginTop:24, fontSize:18, lineHeight:1.55, color:"var(--fg-2)", maxWidth:540 }}>
            Evaluation scenarios for testing AI systems against common attack vectors. YAML templates drop straight into CI/CD. Mapped to OWASP and MITRE ATLAS so the output reads in your existing review process.
          </p>
